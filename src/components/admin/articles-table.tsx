...
export default function ArticlesTable({ articles, isLoading, onDelete }: ArticlesTableProps) {
  ...
  const canManage = useMemo(() => user && isAdmin, [user, isAdmin]);
          ...
          <TableBody>
            {articles.map((article) => (
              <TableRow key={article.id || article._id}>
                <TableCell className="font-medium max-w-xs sm:max-w-sm md:max-w-md">
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <span className="hover:underline line-clamp-2" title={article.title}>
                          {article.title}
                      </span>
                    </TooltipTrigger>
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent>
                                ...
                                <AlertDialogFooter>
                                  ...
                                  >
                                    {isDeleting === article.id ? 'Deleting...' : 'Yes, delete it'}
                                  </AlertDialogAction>
                                </AlertDialogFooter>
                              </AlertDialogContent>
                            </AlertDialog>
